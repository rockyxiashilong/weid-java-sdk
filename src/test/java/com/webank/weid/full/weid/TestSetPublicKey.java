...
public class TestSetPublicKey extends TestBaseServcie {
	...
	public void testSetPublicKeyCase10() {
		...
		Assert.assertEquals(ErrorCode.WEID_PRIVATEKEY_INVALID.getCode(), response.getErrorCode().intValue());
		Assert.assertEquals(false, response.getResult());
	}
	...
	/**
	 * case: Simulation throws an InterruptedException when calling the setAttribute
	 * method.
	 *
	 */
	@Test
